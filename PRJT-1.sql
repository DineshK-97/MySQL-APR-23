...
ALTER TABLE `icc test batting figures (1)` modify column start_year int after span;
ALTER TABLE `icc test batting figures (1)` modify column End_year int after start_year;
